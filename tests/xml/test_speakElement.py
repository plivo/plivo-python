...
class SpeakElementTest(TestCase):
    def test_set_methods(self):
        expected_response = '<Response><Speak language="en-US" loop="1" voice="WOMAN">This is Test' \
                            '<Break strength="strong" time="250ms">This is Test</Break><Emphasis ' \
                            ...
                            '<SayAs format="" interpret_as="spell-out">This is Test</SayAs>' \
