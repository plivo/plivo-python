...
class ProsodyElementTest(TestCase):
    def test_set_methods(self):
        expected_response = '<Response><Speak><prosody pitch="low" rate="x-high" volume="+6dB"><break ' \
                            ...
                            'This is Test</emphasis><lang xml:lang="it">This is Test</lang><p>This is Test' \
                            '</p><phoneme alphabet="ipa" ph="t&amp;#x259;mei&amp;#x325;&amp;#x27E;ou&amp;' \
                            '#x325;">This is Test</phoneme><prosody pitch="low" rate="x-high" volume="+6dB">' \
                            'This is Test</prosody><s>This is Test</s><say-as format="" ' \
                            'interpret-as="spell-out">This is Test</say-as><sub alias="World Wide Web ' \
