    ...
    def test_set_methods(self):
        ...
        response = element.add(
            plivoxml.GetDigitsElement().
                ...
                set_digit_timeout(digitTimeout).
                set_timeout(timeout).
                set_num_digits(numDigits).
                set_retries(retries).
                set_valid_digits(validDigits).
                set_invalid_digits_sound(invalidDigitsSound).
                set_log(log).
                add_speak(content=content_speak,voice=voice_speak,language=language_speak,loop=loop_speak).
                add_play(content=content_play,loop=loop_play)
        ).to_string()
