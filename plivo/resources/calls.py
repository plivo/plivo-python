...
class Calls(PlivoResourceInterface):
    ...
    @validate_args(
        ...
        ring_timeout=[
            optional(
                all_of(
                    of_type(*six.integer_types),
                    check(lambda ring_timeout: 0 < ring_timeout, #I have changed the value of ring_timeout to be greater than 0 since having it equal to zero won't make sense.
    ...
    @validate_args(
        ...
        transcription_url=[optional(is_url())],
    ...
    @validate_args(
        ...
        transcription_url=[optional(is_url())], #will validate entered value.
        transcription_method=[optional(of_type(six.text_type))],
        callback_url=[optional(is_url())],      #will validate entered value.
        callback_method=[optional(of_type(six.text_type))]
    )
    def start_recording(self,
                        call_uuid,
